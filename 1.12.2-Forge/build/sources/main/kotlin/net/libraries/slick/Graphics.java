...
import net.libraries.slick.opengl.renderer.LineStripRenderer;
...
import net.libraries.slick.util.FastTrig;
				...
				public Object run() {
					try {
						DEFAULT_FONT = new AngelCodeFont(
								"net/ccbluex/liquidbounce/libraries/slick/data/defaultfont.fnt",
								"net/ccbluex/liquidbounce/libraries/slick/data/defaultfont.png");
