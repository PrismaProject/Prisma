...
import net.libraries.slick.gui.GUIContext;
...
public abstract class GameContainer implements GUIContext {
	...
	/**
	 * Indicate if we want to Gucel deltas. This feature will report
	 * a delta based on the FPS not the time passed. This works well with 
	 * vsync.
	 * 
	 * @param GucelDeltas True if we should report Gucel deltas
	 */
