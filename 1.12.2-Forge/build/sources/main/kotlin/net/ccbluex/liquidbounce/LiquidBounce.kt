...
import me.Prisma.manager.CombatManager
...
object LiquidBounce {
    ...
    const val CLIENT_NAME = "Prisma"
    const val CrackedVersion = "221113"
    const val CLIENT_VERSION = 1
    const val IN_DEV = true
    @kotlin.jvm.JvmField
    public val HWID = HWIDUtils.getHWID()
    const val CLIENT_CREATOR = "CCBlueX"
    const val UserCode = "26v7fi2"
