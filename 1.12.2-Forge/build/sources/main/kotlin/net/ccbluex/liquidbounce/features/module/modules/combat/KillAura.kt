...
class KillAura : Module() {
    ...
    private val blockModeValue = ListValue("BlockMode", arrayOf("None", "Packet", "Mouse", "GameSettings", "UseItem" ), "Packet")
    ...
    private val markModeValue = ListValue("Mark", arrayOf( "IDK", "Circle","Plat","Box","Off"), "Jello")
