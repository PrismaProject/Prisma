...
class RainbowFontShaderLow : Shader("rainbow_font_shader.frag"), Closeable {
    var isInUse = false
        private set
    ...
    companion object {
        @JvmField
        val INSTANCE = RainbowFontShaderLow()

        @Suppress("NOTHING_TO_INLINE")
        inline fun begin(enable: Boolean, x: Float, y: Float, offset: Float): RainbowFontShaderLow {
