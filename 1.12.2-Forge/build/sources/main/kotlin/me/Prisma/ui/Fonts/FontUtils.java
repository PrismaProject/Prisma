package me.Prisma.ui.Fonts;



import me.Prisma.ui.Fonts.FluxFont;
...
public class FontUtils {
    ...
    private Font getFont(String fontName, int fontType, int size) {
        ...
        try {
            InputStream ex = FontManager.class.getResourceAsStream("/assets/minecraft/Prisma/font/" + fontName);
    ...
    public void drawLimitedStringWithAlpha(String text, float x, float y, int color, float alpha, float maxWidth) {
        ...
        for (char c : characters) {
            ...
            if (c != '\247' && (index == 0 || index == characters.length - 1 || characters[index - 1] != '\247')) {
                ...
                glPushMatrix();
                unicodeFont.drawString(Character.toString(c), x, y, RenderUtils.reAlpha(currentColor, alpha), false);
                glPopMatrix();
