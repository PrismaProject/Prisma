...
public final class GuiUserField extends Gui
{
    ...
    public GuiUserField(final FontRenderer p_i1032_1_, final int p_i1032_2_, final int p_i1032_3_, final int p_i1032_4_, final int p_i1032_5_) {
        super();
        ...
        this.field_146221_u = new Color(0,0,0).getRGB();
        this.field_146222_t = new Color(0,0,0).getRGB();
    ...
    public void drawTextBox2() {
        if (this.func_146176_q()) {
            ...
            if (this.func_146181_i()) {
//                RenderUtil.drawFastRoundedRect(this.field_146209_f - 1, this.field_146210_g - 1, this.field_146209_f + this.field_146218_h + 1, this.field_146210_g + this.field_146219_i + 1,10,new Color(200,200,200).getRGB());
//                RenderUtil.drawFastRoundedRect(this.field_146209_f, this.field_146210_g, this.field_146209_f + this.field_146218_h, this.field_146210_g + this.field_146219_i,10, new Color(255,255,255).getRGB());
            }
            final int var1 = this.field_146226_p ? this.field_146222_t : this.field_146221_u;
            final int var2 = this.field_146224_r - this.field_146225_q;
            int var3 = this.field_146223_s - this.field_146225_q;
            ...
            if (var4.length() > 0) {
                final String var10 = var5 ? var4.substring(0, var2) : var4;
                var9 = (int) FontLoaders.xyz18.drawString(var10, var7, var8  +1, new Color(0,0,0).getRGB());
            }
            final boolean var11 = this.field_146224_r < this.field_146216_j.length() || this.field_146216_j.length() >= this.func_146208_g();
            int var12 = var9;
            if (!var5) {
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
                FontLoaders.xyz18.drawString(var4.substring(var2), var9 + 2, var8 + 1,  new Color(0,0,0).getRGB());
            }
            if (var6) {
                if (var11) {
                    Gui.drawRect(var9, var8,   var12 + 1, var8 + 1 + this.field_146211_a.FONT_HEIGHT, -3092272);
                }
                else {
                    FontLoaders.xyz20.drawString("_", var12 + 1, var8, var1);
                }
            }
            if (var3 != var2) {
                final int var13 = var7 + this.field_146211_a.getStringWidth(var4.substring(0, var3).replaceAll(".", "*"));
