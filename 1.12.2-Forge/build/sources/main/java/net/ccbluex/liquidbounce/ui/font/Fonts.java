...
public class Fonts extends MinecraftInstance {
    ...
    public static void loadFonts() {
        ...
        jello40 =classProvider.wrapFontRenderer(new GameFontRenderer(getFont("Prisma/font/jello.ttf", 40)));
        jello120 =classProvider.wrapFontRenderer(new GameFontRenderer(getFont("Prisma/font/jello.ttf", 120)));
        jello35 =classProvider.wrapFontRenderer(new GameFontRenderer(getFont("Prisma/font/jello.ttf", 35)));
        jello60=classProvider.wrapFontRenderer(new GameFontRenderer(getFont("Prisma/font/jello.ttf", 60)));
        jello37=classProvider.wrapFontRenderer(new GameFontRenderer(getFont("Prisma/font/jello.ttf", 37)));
        jello30=classProvider.wrapFontRenderer(new GameFontRenderer(getFont("Prisma/font/jello.ttf", 30)));
        jello45=classProvider.wrapFontRenderer(new GameFontRenderer(getFont("Prisma/font/jello.ttf", 45)));
        jello72 =classProvider.wrapFontRenderer(new GameFontRenderer(getFont("Prisma/font/jello.ttf", 72)));
    ...
    private static Font getJello(int size) {
        Font font;
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("Prisma/font/jello.ttf")).getInputStream();
    ...
    private static Font getBold(int size) {
        Font font;
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("Prisma/font/bold.ttf")).getInputStream();
            font = Font.createFont(0, is);
            font = font.deriveFont(0, size);
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private static Font getSFUI(int size) {
        Font font;
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("Prisma/font/sfuidisplayregular.ttf")).getInputStream();
            font = Font.createFont(0, is);
            font = font.deriveFont(0, size);
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private static Font getComfortaaRegular(int size) {
        Font font;
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("Prisma/font/ComfortaaRegular.ttf")).getInputStream();
            font = Font.createFont(0, is);
            font = font.deriveFont(0, size);
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private static Font getCasanovaScotia(int size) {
        Font font;
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("Prisma/font/CasanovaScotia.ttf")).getInputStream();
            font = Font.createFont(0, is);
            font = font.deriveFont(0, size);
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private static Font getAlibabaSansLight(int size) {
        Font font;
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("Prisma/font/AlibabaSansLight.ttf")).getInputStream();
            font = Font.createFont(0, is);
            font = font.deriveFont(0, size);
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private static Font getFlux(int size) {
        Font font;
        try {
            InputStream is = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("Prisma/font/fluxicon.ttf")).getInputStream();
            font = Font.createFont(0, is);
            font = font.deriveFont(0, size);
        } catch (Exception ex) {
            ex.printStackTrace();
