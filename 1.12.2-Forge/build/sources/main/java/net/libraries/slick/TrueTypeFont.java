...
import net.libraries.slick.opengl.GLUtils;
import net.libraries.slick.opengl.Texture;
import net.libraries.slick.util.BufferedImageUtil;
...
public class TrueTypeFont implements Font {
	...
	public void drawString(float x, float y, String whatchars,
			net.libraries.slick.Color color) {
		drawString(x,y,whatchars,color,0,whatchars.length()-1);
	}
	
	/**
	 * @see Font#drawString(float, float, String, net.libraries.slick.Color, int, int)
	 */
	public void drawString(float x, float y, String whatchars,
                           net.libraries.slick.Color color, int startIndex, int endIndex) {
		color.bind();
		fontTexture.bind();
	 ...
	 */
	public void drawString(float x, float y, String whatchars) {
		drawString(x, y, whatchars, net.libraries.slick.Color.white);
	}
