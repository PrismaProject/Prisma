...
package net.libraries.slick.font;
...
import net.libraries.slick.font.effects.ConfigurableEffect;
import net.libraries.slick.util.ResourceLoader;

/**
 * Holds the ModueSettings needed to configure a UnicodeFont.
 * 
...
public class HieroSettings {
	 ...
	 * Create a new set of configuration from a file
	 * 
	 * @param in The stream from which to read the ModueSettings from
	 * @throws SlickException if the file could not be read.
	 */
	...
	/**
	 * Saves the ModueSettings to a file.
	 * 
