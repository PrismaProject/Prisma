package net.libraries.slick.tests.xml;

import net.libraries.slick.util.xml.ObjectTreeParser;
import net.libraries.slick.util.xml.SlickXMLException;
...
public class ObjectParserTest {
	...
	public static void main(String[] argv) throws SlickXMLException {
		ObjectTreeParser parser = new ObjectTreeParser("net.libraries.slick.tests.xml");
