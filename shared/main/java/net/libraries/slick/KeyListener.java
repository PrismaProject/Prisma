...
public interface KeyListener extends ControlledInputReciever {
	 ...
	 * 
	 * @param key The key code that was pressed (@see me.kiras.andrew.libraries.slick.Input)
	 ...
	 * 
	 * @param key The key code that was released (@see me.kiras.andrew.libraries.slick.Input)
