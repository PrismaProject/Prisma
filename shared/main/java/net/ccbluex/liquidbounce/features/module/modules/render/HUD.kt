...
class HUD : Module() {
    ...
    val logValue = ListValue("LogMode", arrayOf("idk", "141Sense", "Jello", "PowerX", "None", "Novoline"), "141Sense")
    val ClientName = TextValue("ClientName", "Prisma")
    val DevName = TextValue("DevName", "YuanXi_Cute")
    ...
    fun onScreen(event: ScreenEvent) {
        ...
        if (state && blurValue.get() && !mc.entityRenderer.isShaderActive() && event.guiScreen != null &&
                ...
                mc.entityRenderer.shaderGroup!!.shaderGroupName.contains("Prisma/blur.json")) mc.entityRenderer.stopUseShader()
    }
